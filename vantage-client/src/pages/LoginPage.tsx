...
function LoginPage() {
  ...
  }, [loginSuccess, searchParams, navigate]);
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (errors.email && e.target.name === 'email') {
      setErrors({ ...errors, email: undefined });
    }
    if (errors.password && e.target.name === 'password') {
      ...
      <main className="flex-1 flex items-center justify-center px-4 md:px-6 py-10 md:py-16">
        ...
        >
          ...
          >
            ...
            <Link to="/signup" style={{ color: 'var(--color-interactive)', fontWeight: 600 }}>
              Sign up
            </Link>
          </motion.p>
        </motion.div>
